...
window.DREAM_API_CLIENT_VERSION = "v439-profile-routing";
...
function dreamIsInnPageV384(){ return dreamCurrentPageV384()==="inn"; }
...
function $(sel, root=document){ return root.querySelector(sel); }
  ...
  async function loadRanking(){
    // v431: public ranking is background data; use the stabilizer/cache and never block login.
    if(typeof dreamIsLoginPageV378==="function" && dreamIsLoginPageV378()) return;
